...
offset_str = []
offset_str.append(Ultrasonic('F', Pose(0.0,8.4,0.0), sensor_noise))
offset_str.append(Ultrasonic('L', Pose(-5.0,3.4,pi/2), sensor_noise))
offset_str.append(Ultrasonic('R', Pose(5.0,3.4,-pi/2), sensor_noise))
offset_str.append(Ultrasonic('B', Pose(0.0,-1.6,-pi), sensor_noise))
