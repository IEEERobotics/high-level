...
class BlobTracker(FrameProcessor):
  """Detects and tracks colored blobs using masks generated by a color filter, if available."""
  
  State = Enum(['INIT', 'LIVE'])
  minBlobArea = 500
  
  def __init__(self, colorFilterProcessor=None):
    FrameProcessor.__init__(self)
    self.colorFilterProcessor = colorFilterProcessor  # keep a reference to a ColorFilterProcessor, if given
    self.debug = True
